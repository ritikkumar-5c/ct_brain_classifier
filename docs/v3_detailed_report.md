...
| target sens | threshold | Not-Normal Sensitivity | Not-Normal Specificity | Not-Normal Precision | Normal Precision (NPV) | Not-Normal FAR (1−spec) | TP / FP / FN / TN |
|--:|--:|--:|--:|--:|--:|--:|--|
| 0.95 | 0.179 | 0.941 | 0.452 | 0.867 | 0.669 | 0.548 | 1955 / 299 / 122 / 247 |
| 0.96 | 0.128 | 0.951 | 0.399 | 0.858 | 0.683 | 0.601 | 1976 / 328 / 101 / 218 |
| 0.97 | 0.090 | 0.962 | 0.342 | 0.848 | 0.706 | 0.658 | 1999 / 359 / 78 / 187 |
| **0.98** | 0.052 | **0.977** | **0.244** | **0.831** | 0.739 | **0.756** | 2030 / 413 / 47 / 133 |
| 0.99 | 0.030 | 0.986 | 0.143 | 0.814 | 0.729 | 0.857 | 2048 / 468 / 29 / 78 |
...
**Normal Precision (NPV)** = TN/(TN+FN) = of all cases the model leaves un-flagged ("normal"), the fraction that are truly normal — the rule-out reliability at this operating point.
...
| target sens | threshold | Not-Normal Sensitivity | Not-Normal Specificity | Not-Normal Precision | Normal Precision (NPV) | Not-Normal FAR (1−spec) | TP / FP / FN / TN |
|--:|--:|--:|--:|--:|--:|--:|--|
| 0.95 | 0.208 | 0.945 | 0.488 | 0.873 | 0.704 | 0.512 | 1178 / 172 / 69 / 164 |
| 0.96 | 0.152 | 0.953 | 0.420 | 0.859 | 0.705 | 0.580 | 1188 / 195 / 59 / 141 |
| 0.97 | 0.105 | 0.966 | 0.357 | 0.848 | 0.736 | 0.643 | 1204 / 216 / 43 / 120 |
| 0.98 | 0.066 | 0.978 | 0.289 | 0.836 | 0.776 | 0.711 | 1219 / 239 / 28 / 97 |
| 0.99 | 0.038 | 0.986 | 0.196 | 0.820 | 0.795 | 0.804 | 1230 / 270 / 17 / 66 |

### Screening operating points — PATIENT-level [max] (threshold on VAL → TEST; 1,583 patients)
| target sens | threshold | Not-Normal Sensitivity | Not-Normal Specificity | Not-Normal Precision | Normal Precision (NPV) | Not-Normal FAR (1−spec) | TP / FP / FN / TN |
|--:|--:|--:|--:|--:|--:|--:|--|
| 0.95 | 0.235 | 0.947 | 0.458 | 0.866 | 0.700 | 0.542 | 1181 / 182 / 66 / 154 |
| 0.96 | 0.175 | 0.957 | 0.414 | 0.858 | 0.724 | 0.586 | 1194 / 197 / 53 / 139 |
| 0.97 | 0.116 | 0.968 | 0.351 | 0.847 | 0.747 | 0.649 | 1207 / 218 / 40 / 118 |
| 0.98 | 0.072 | 0.979 | 0.286 | 0.836 | 0.787 | 0.714 | 1221 / 240 / 26 / 96 |
| 0.99 | 0.039 | 0.987 | 0.182 | 0.817 | 0.792 | 0.818 | 1231 / 275 / 16 / 61 |
